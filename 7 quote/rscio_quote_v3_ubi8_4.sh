# -----------------------------------------------------------------------------
#
# Package	: rsc.io/quote/v3
# Version	: v3.1.0
# Source repo	: https://github.com/rsc/quote.git
# Tested on	: UBI8:8.4-211
...
PACKAGE_NAME=rsc.io/quote/v3
PACKAGE_VERSION=${1:-v3.1.0}
PACKAGE_URL=https://github.com/rsc/quote
...
# Ensure go.mod file exists
go mod init
#Add rsc.io/sampler v1.3.0 externally or else it builds the master version
